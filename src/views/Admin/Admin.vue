          ...
          <div class="col d-flex">
            <div class="cardInfo">
              ...
              <div class="rightCard">
                ...
                <div class="nameCard">Đơn đã hủy</div>
              </div>
            </div>
          </div>
          <div class="col d-flex">
            <div class="cardInfo">
              ...
              <div class="rightCard">
                ...
                <div class="nameCard">Đơn chờ</div>
              </div>
            </div>
          </div>
          <div class="col d-flex">
            <div class="cardInfo">
              ...
              <div class="rightCard">
                ...
                <div class="nameCard">Nhân viên</div>
              </div>
            </div>
          </div>
          <div class="col d-flex">
            <div class="cardInfo">
              ...
              <div class="rightCard">
                ...
                <div class="nameCard">Độc giả</div>
              </div>
            </div>
          </div>
        </div>
  ...
  axios
    ...
    .then((res) => {
      ...
      if (res.data.error) {
        ...
        fetchData();
        dashBoard();
        toast.success("Đã duyệt đơn mượn.");
      }
    })
    .catch((err) => console.log(err));
};
  ...
  axios
    ...
    .then((res) => {
      if (res.data.error) {
        ...
        fetchData();
        dashBoard();
        toast.success("Đã từ chối đơn mượn.");
      }
    })
    .catch((err) => console.log(err));
};
