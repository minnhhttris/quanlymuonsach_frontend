          ...
          <div class="col col-xl-10">
            <div class="card loginForm">
              <div class="row g-0" style="min-height: 500px">
                <div class="col-md-6 col-lg-6 d-flex align-items-center login-container">
                  <div class="card-body p-4 p-lg-5 text-black ">
                    <form @submit.prevent="login">
                      <div class="d-flex align-items-center mb-2 text-center">
                        <div class="titleWeb">Đăng nhập</div>
                      </div>
                      <div class="group">
                      ...
                      <div class="pt-1 text-right"> 
                        <a class="small text-muted d-block" href="#!">Quên mật khẩu?</a>
                      </div>
                      <div class="pt-1 mb-4 d-flex justify-content-center">
                        <button class="btnPay">Đăng nhập</button>
                      </div>

                      <div class="row d-flex justify-content-center align-items-center ms-2">
                        <text class="mr-2">Chưa có tài khoản?</text>
                ...
                <div class="col-md-6 col-lg-6">
                  <div class="wrapper">
                    <img src="../../../assets/img/pngwing.png" alt="bookalt" class="book-img">
                    <div class="title">Hi NavyBook</div>
                    <p>
                      Chào mừng đến với NavyBook -
                      Nơi có thể khám phá lượng kiến thức vô tận
                      bởi sự đắm mình trong những cuốn sách hay và tuyệt vời!
                    </p>
